...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_PREDICATES_FUNCTIONS_SIMD_VMX_ALTIVEC_IS_EQUAL_WITH_EQUAL_NANS_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_PREDICATES_FUNCTIONS_SIMD_VMX_ALTIVEC_IS_EQUAL_WITH_EQUAL_NANS_HPP_INCLUDED
...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( is_equal_with_equal_nans_, boost::simd::tag::altivec_, (A0)
