...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION(is_not_greater_, boost::simd::tag::sse2_,
                         (A0),
                        ...
                        )
  {
    ...
    {
      result_type that =  { _mm_cmpngt_pd(a0,a1)}; return that;
    }
  };
                        ...
                        )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL_REPEAT(2)
    {
      result_type that =  { _mm_cmpngt_ps(a0,a1)}; return that;
    }
  };
} } }
#endif
