 ...
 * \endcode
 *
 * \param a0 the unique parameter of is_gez
 * 
...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct is_gez_ : ext::elementwise_<is_gez_> { typedef ext::elementwise_<is_gez_> parent; };
    BOOST_SIMD_FUNCTION_DECLARE(is_gez_)
  }
