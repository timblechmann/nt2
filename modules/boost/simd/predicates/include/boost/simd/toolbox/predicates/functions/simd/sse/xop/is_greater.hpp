...
#define NT2_XOP_COMP(TYPE_TAG, SUFFIX)                                  \
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION(                                    \
                       boost::simd::tag::is_greater_, boost::simd::tag::xop_    \
                       , (A0)                                           \
  ...
  {                                                                     \
    ...
    result_type operator()(__m128i const a0, __m128i const a1) const    \
      {                                                                 \
        return  BOOST_PP_CAT(_mm_comgt_ep, SUFFIX)(a0,a1);              \
      }                                                                 \
  };                                                                    \
    /**/
...
#undef NT2_XOP_COMP
    ...
    BOOST_SIMD_FUNCTOR_IMPLEMENTATION(boost::simd::tag::is_greater_, boost::simd::tag::xop_    
                                      , (A0)                                           
