...
#define NT2_XOP_COMP(TYPE_TAG, SUFFIX)                                  \
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION(                                    \
             boost::simd::tag::is_not_equal_, boost::simd::tag::xop_    \
                       , (A0)                                           \
  ...
  {                                                                     \
    ...
    result_type operator()(__m128i const a0, __m128i const a1) const    \
      {                                                                 \
        return  BOOST_PP_CAT(_mm_comneq_ep, SUFFIX)(a0,a1);             \
      }                                                                 \
  };                                                                    \
    /**/
...
#undef NT2_XOP_COMP
    ...
    BOOST_SIMD_FUNCTOR_IMPLEMENTATION(boost::simd::tag::is_not_equal_, boost::simd::tag::xop_    
                                      , (A0)                                           
  ...
  {                                                                     
    ...
    result_type operator()(__m256i const a0, __m256i const a1) const    
    {
      ...
      btype r0 = is_not_equal(a00, a10); 
      btype r1 = is_not_equal(a01, a11); 
