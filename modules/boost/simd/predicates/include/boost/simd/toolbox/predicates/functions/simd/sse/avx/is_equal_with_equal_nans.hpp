...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( is_equal_with_equal_nans_, boost::simd::tag::avx_
                            , (A0)
                            ...
                            )
  {
    ...
    {
      result_type that = { _mm256_cmp_pd(a0,a1, _CMP_EQ_UQ) };
      return that;
    }
  };
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL_REPEAT(2)
    {
      result_type that = { _mm256_cmp_ps(a0,a1, _CMP_EQ_UQ) };
      return that;
    }
  };
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL_REPEAT(2)
    {
      result_type that = { _mm_cmp_pd(a0,a1, _CMP_EQ_UQ) };
      return that;
    }
  };
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL_REPEAT(2)
    {
      result_type that = { _mm_cmp_ps(a0,a1, _CMP_EQ_UQ) };
      return that;
    }
  };
