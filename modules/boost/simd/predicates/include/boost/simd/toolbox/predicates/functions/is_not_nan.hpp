 ...
 * \file
**/
#ifndef BOOST_SIMD_TOOLBOX_PREDICATES_FUNCTIONS_IS_NOT_NAN_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_PREDICATES_FUNCTIONS_IS_NOT_NAN_HPP_INCLUDED
...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    ...
    BOOST_SIMD_FUNCTION_DECLARE(is_not_nan_)
  }
