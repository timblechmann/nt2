...
NT2_TEST_CASE_TPL ( sb2b_real__1_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(sb2b(boost::simd::Half<vT>())[0]!=0, boost::simd::True<sr_t>());
  NT2_TEST_EQUAL(sb2b(boost::simd::Inf<vT>())[0]!=0, boost::simd::True<sr_t>());
  NT2_TEST_EQUAL(sb2b(boost::simd::Minf<vT>())[0]!=0, boost::simd::True<sr_t>());
  NT2_TEST_EQUAL(sb2b(boost::simd::Mone<vT>())[0]!=0, boost::simd::True<sr_t>());
  NT2_TEST_EQUAL(sb2b(boost::simd::Nan<vT>())[0]!=0, boost::simd::True<sr_t>());
  NT2_TEST_EQUAL(sb2b(boost::simd::One<vT>())[0]!=0, boost::simd::True<sr_t>());
