...
NT2_TEST_CASE_TPL ( is_equal_integer__2_0,  BOOST_SIMD_SIMD_INTEGRAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_equal(boost::simd::One<vT>(), boost::simd::One<vT>())&1!=0, true);
  NT2_TEST_EQUAL(is_equal(boost::simd::One<vT>(),boost::simd::Zero<vT>())&1!=0, false);
  NT2_TEST_EQUAL(is_equal(boost::simd::Zero<vT>(), boost::simd::Zero<vT>())&1!=0, true);
...
NT2_TEST_CASE_TPL ( is_equal_real__2_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_EQUAL(is_equal(boost::simd::Inf<vT>(), boost::simd::Inf<vT>())&1!=0, true);
  NT2_TEST_EQUAL(is_equal(boost::simd::Minf<vT>(), boost::simd::Minf<vT>())&1!=0, true);
  NT2_TEST_EQUAL(is_equal(boost::simd::Nan<vT>(), boost::simd::Nan<vT>())&1!=0, false);
  NT2_TEST_EQUAL(is_equal(boost::simd::One<vT>(),boost::simd::Zero<vT>())&1!=0, false);
  NT2_TEST_EQUAL(is_equal(boost::simd::Zero<vT>(), boost::simd::Zero<vT>())&1!=0, true);
