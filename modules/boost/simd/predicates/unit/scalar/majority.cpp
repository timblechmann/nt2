...
NT2_TEST_CASE_TPL ( majority_real__3_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(majority(boost::simd::Half<T>(), boost::simd::Half<T>(), boost::simd::Half<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(majority(boost::simd::Inf<T>(), boost::simd::Inf<T>(), boost::simd::Inf<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(majority(boost::simd::Minf<T>(), boost::simd::Minf<T>(), boost::simd::Minf<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(majority(boost::simd::Mone<T>(), boost::simd::Mone<T>(), boost::simd::Mone<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(majority(boost::simd::Nan<T>(), boost::simd::Nan<T>(), boost::simd::Nan<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(majority(boost::simd::One<T>(), boost::simd::One<T>(), boost::simd::One<T>()), boost::simd::True<r_t>());
