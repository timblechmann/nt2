...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost.simd.predicates toolbox - is_equal/scalar Mode"
...
NT2_TEST_CASE_TPL ( is_equal_integer__2_0,  BOOST_SIMD_INTEGRAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_equal(boost::simd::One<T>(), boost::simd::One<T>()), true);
  NT2_TEST_EQUAL(is_equal(boost::simd::One<T>(),boost::simd::Zero<T>()), false);
  NT2_TEST_EQUAL(is_equal(boost::simd::Zero<T>(), boost::simd::Zero<T>()), true);
...
NT2_TEST_CASE_TPL ( is_equal_real__2_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_EQUAL(is_equal(boost::simd::Inf<T>(), boost::simd::Inf<T>()), true);
  NT2_TEST_EQUAL(is_equal(boost::simd::Minf<T>(), boost::simd::Minf<T>()), true);
  NT2_TEST_EQUAL(is_equal(boost::simd::Nan<T>(), boost::simd::Nan<T>()), false);
  NT2_TEST_EQUAL(is_equal(boost::simd::One<T>(),boost::simd::Zero<T>()), false);
  NT2_TEST_EQUAL(is_equal(boost::simd::Zero<T>(), boost::simd::Zero<T>()), true);
