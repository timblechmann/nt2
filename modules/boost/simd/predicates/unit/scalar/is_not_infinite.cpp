...
NT2_TEST_CASE_TPL ( is_not_infinite_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_not_infinite(-boost::simd::Zero<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_not_infinite(boost::simd::Half<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_not_infinite(boost::simd::Inf<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_not_infinite(boost::simd::Minf<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_not_infinite(boost::simd::Mone<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_not_infinite(boost::simd::Nan<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_not_infinite(boost::simd::One<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_not_infinite(boost::simd::Quarter<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_not_infinite(boost::simd::Two<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_not_infinite(boost::simd::Zero<T>()), boost::simd::True<r_t>());
