...
NT2_TEST_CASE_TPL ( is_nltz_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_nltz(-boost::simd::Zero<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_nltz(boost::simd::Half<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_nltz(boost::simd::Inf<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_nltz(boost::simd::Minf<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_nltz(boost::simd::Mone<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_nltz(boost::simd::Nan<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_nltz(boost::simd::One<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_nltz(boost::simd::Quarter<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_nltz(boost::simd::Two<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_nltz(boost::simd::Zero<T>()), boost::simd::True<r_t>());
