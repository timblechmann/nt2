...
NT2_TEST_CASE_TPL ( is_eqz_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_eqz(-boost::simd::Zero<T>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Half<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Inf<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Minf<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Mone<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Nan<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::One<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Quarter<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Two<T>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Zero<T>()), boost::simd::True<r_t>());
