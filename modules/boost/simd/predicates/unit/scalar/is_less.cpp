...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost.simd.predicates toolbox - is_less/scalar Mode"
...
NT2_TEST_CASE_TPL ( is_less_integer__2_0,  BOOST_SIMD_INTEGRAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_less(boost::simd::One<T>(), boost::simd::One<T>()), false);
  NT2_TEST_EQUAL(is_less(boost::simd::One<T>(),boost::simd::Zero<T>()), false);
  NT2_TEST_EQUAL(is_less(boost::simd::Zero<T>(), boost::simd::Zero<T>()), false);
...
NT2_TEST_CASE_TPL ( is_less_real__2_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_EQUAL(is_less(boost::simd::Inf<T>(), boost::simd::Inf<T>()), false);
  NT2_TEST_EQUAL(is_less(boost::simd::Minf<T>(), boost::simd::Minf<T>()), false);
  NT2_TEST_EQUAL(is_less(boost::simd::Nan<T>(), boost::simd::Nan<T>()), false);
  NT2_TEST_EQUAL(is_less(boost::simd::One<T>(),boost::simd::Zero<T>()), false);
  NT2_TEST_EQUAL(is_less(boost::simd::Zero<T>(), boost::simd::Zero<T>()), false);
