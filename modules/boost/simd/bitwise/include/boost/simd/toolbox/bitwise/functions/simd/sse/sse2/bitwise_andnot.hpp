...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_IF ( bitwise_andnot_, boost::simd::tag::sse2_, (A0)(A1)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION(bitwise_andnot_, boost::simd::tag::sse2_, (A0),
