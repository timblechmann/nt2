...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION_IF ( bitwise_notand_, boost::simd::tag::sse2_, (A0)(A1)
                              ...
                              )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(2)
    {
      ...
      return bitwise_cast<A0>( _mm_andnot_si128( bitwise_cast<int_type>(a0)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION(bitwise_notand_, boost::simd::tag::sse2_, (A0),
