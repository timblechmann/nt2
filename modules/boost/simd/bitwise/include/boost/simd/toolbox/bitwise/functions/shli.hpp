 ...
 * \endcode
 *
 * \param a0 the first parameter of shli
 * \param a1 the second parameter of shli, must be a scalar integer value
 * 
...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    struct shli_ : ext::elementwise_<shli_> { typedef ext::elementwise_<shli_> parent; };
    BOOST_SIMD_FUNCTION_DECLARE(shli_)
  }
