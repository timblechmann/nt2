...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 boost.simd.bitwise toolbox - bitwise_andnot/simd Mode"
...
NT2_TEST_CASE_TPL ( bitwise_andnot_real__2_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( bitwise_andnot_integer__2_0,  BOOST_SIMD_SIMD_INTEGRAL_TYPES)
{
  using boost::simd::bitwise_andnot;
  using boost::simd::tag::bitwise_andnot_;
  using boost::simd::native;
  ...
  typedef typename boost::simd::meta::scalar_of<r_t>::type ssr_t;
  // specific values tests
  NT2_TEST_EQUAL(bitwise_andnot(boost::simd::One<vT>(), boost::simd::One<vT>())[0], boost::simd::Zero<sr_t>());
  NT2_TEST_EQUAL(bitwise_andnot(boost::simd::One<vT>(),boost::simd::Zero<vT>())[0], boost::simd::One<sr_t>());
  NT2_TEST_EQUAL(bitwise_andnot(boost::simd::Zero<vT>(), boost::simd::Zero<vT>())[0], boost::simd::Zero<sr_t>());
