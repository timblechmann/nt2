...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 boost.simd.bitwise toolbox - rror/simd Mode"
...
NT2_TEST_CASE_TPL ( rror_integer__2_0,  BOOST_SIMD_SIMD_INTEGRAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(rror(boost::simd::Zero<vT>(), boost::simd::Zero<vT>())[0], boost::simd::Zero<sr_t>());
