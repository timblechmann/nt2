...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 boost.simd.bitwise toolbox - bits/simd Mode"
...
NT2_TEST_CASE_TPL ( bits_real__1_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  typedef typename boost::dispatch::meta::call<bits_(vT)>::type r_t;
...
NT2_TEST_CASE_TPL ( bits_signed_int__1_0,  BOOST_SIMD_SIMD_INTEGRAL_SIGNED_TYPES)
{
  using boost::simd::bits;
  using boost::simd::tag::bits_;
  using boost::simd::native;
...
NT2_TEST_CASE_TPL ( bits_unsigned_int__1_0,  BOOST_SIMD_SIMD_UNSIGNED_TYPES)
{
  using boost::simd::bits;
  using boost::simd::tag::bits_;
  using boost::simd::native;
