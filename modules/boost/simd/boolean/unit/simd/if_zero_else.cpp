...
NT2_TEST_CASE_TPL ( if_zero_else_real__2_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(if_zero_else(boost::simd::False<vlT>(),boost::simd::splat<vT>(1))[0], 1);
  NT2_TEST_EQUAL(if_zero_else(boost::simd::False<vlT>(),boost::simd::Nan<vT>())[0], boost::simd::Nan<T>());
  NT2_TEST_EQUAL(if_zero_else(boost::simd::True<vlT>(),boost::simd::splat<vT>(1))[0], 0);
  NT2_TEST_EQUAL(if_zero_else(boost::simd::True<vlT>(),boost::simd::Nan<vT>())[0], 0);
