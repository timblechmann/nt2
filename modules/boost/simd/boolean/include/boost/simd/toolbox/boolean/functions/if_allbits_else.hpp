...
//////////////////////////////////////////////////////////////////////////////
#ifndef BOOST_SIMD_TOOLBOX_BOOLEAN_FUNCTIONS_IF_ALLBITS_ELSE_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_BOOLEAN_FUNCTIONS_IF_ALLBITS_ELSE_HPP_INCLUDED
/*!
 * \file
**/
...
namespace boost { namespace simd { namespace tag
  {
    ...
    **/
    ...
    BOOST_SIMD_FUNCTION_DECLARE(if_allbits_else_)
  }
