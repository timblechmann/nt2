...
NT2_TEST_CASE_TPL ( oneplus_real__1_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(oneplus(boost::simd::Inf<vT>())[0], boost::simd::Inf<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(oneplus(boost::simd::Minf<vT>())[0], boost::simd::Minf<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(oneplus(boost::simd::Mone<vT>())[0], boost::simd::Zero<sr_t>(), 0);
