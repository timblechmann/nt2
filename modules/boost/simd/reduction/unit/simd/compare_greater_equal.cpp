...
NT2_TEST_CASE_TPL ( compare_greater_equal_real__2_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::Minf<vT>(), boost::simd::Minf<vT>()), r_t(true));
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::Nan<vT>(), boost::simd::Nan<vT>()), r_t(true));
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::One<vT>(),boost::simd::Zero<vT>()), r_t(true));
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::Zero<vT>(), boost::simd::Zero<vT>()), r_t(true));
