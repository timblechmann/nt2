...
//==============================================================================
#ifndef BOOST_SIMD_SDK_MEMORY_MAKE_ALIGNED_INCLUDED
#define BOOST_SIMD_SDK_MEMORY_MAKE_ALIGNED_INCLUDED
...
{
  /*!
    @brief Mark pointer as porperly aligned
    ...
    flag it as aligned so the compiler can keep track of this constraint in its
    optimization pass.
  ...
  **/
  ...
  BOOST_FORCEINLINE typename meta::make_aligned<T,Alignment>::type*
  make_aligned(T* const pointer)
  {
    BOOST_ASSERT_MSG
    ...
    return meta::make_aligned<T,Alignment>::value(pointer);
  }
