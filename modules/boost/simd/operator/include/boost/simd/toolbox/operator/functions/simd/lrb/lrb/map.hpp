...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_OPERATOR_FUNCTIONS_SIMD_LRB_LRB_MAP_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_OPERATOR_FUNCTIONS_SIMD_LRB_LRB_MAP_HPP_INCLUDED
...
////////////////////////////////////////////////////////////////////////////////
// Implement a SIMD map that apply a given function to any LRB vector types
...
#define M0(z,n,h) ((simd_< h <A##n>, boost::simd::tag::lrb_ >))
...
{                                                                            \
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( boost::simd::tag::map_, boost::simd::tag::lrb_       \
  ...
  {                                                                          \
    ...
    as_native< Func                                                          \
             ...
             >::type                                                         \
    stype;                                                                   \
    typedef simd::native<stype, tag::lrb_> result_type;                      \
                                                                             \
    inline result_type                                                       \
...
BOOST_SIMD_MAP_CALL(type64_ ,  8)
BOOST_SIMD_MAP_CALL(type32_ ,  16)
