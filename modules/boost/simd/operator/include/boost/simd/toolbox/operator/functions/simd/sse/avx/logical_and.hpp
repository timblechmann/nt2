...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_OPERATOR_FUNCTIONS_SIMD_SSE_AVX_LOGICAL_AND_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_OPERATOR_FUNCTIONS_SIMD_SSE_AVX_LOGICAL_AND_HPP_INCLUDED
...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( logical_and_, boost::simd::tag::avx_
                            , (A0)(A1)
