...
namespace boost { namespace simd { namespace ext
{
  ...
  ( logical_or_, boost::simd::tag::sse2_, (A0)(A1)
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( logical_or_, boost::simd::tag::sse2_
                            , (A0)(A1)
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(2)
    {
      ...
      return bitwise_cast<result_type>(b_or(bitwise_cast<type>(a0), bitwise_cast<type>(a1)));
    }
  };
} } }
