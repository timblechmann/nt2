 ...
 * \defgroup boost_simd_operator_compare_greater compare_greater
 *
 * \par Description
...
namespace boost { namespace simd
{
  namespace tag
  {
    ...
    **/
    ...
    BOOST_SIMD_FUNCTION_DECLARE(compare_greater_)
  }
...
namespace boost { namespace dispatch { namespace meta
{
  ...
  template<>
  struct proto_tag<boost::simd::tag::compare_greater_>
  {
