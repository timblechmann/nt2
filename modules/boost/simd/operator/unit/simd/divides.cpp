...
NT2_TEST_CASE_TPL ( divides_integer__2_0,  (boost::simd::int32_t) (boost::simd::uint32_t))//BOOST_SIMD_SIMD_INTEGRAL_TYPES)
{
  using boost::simd::divides;
  using boost::simd::tag::divides_;
  using boost::simd::load; 
  ...
  NT2_TEST_EQUAL(divides(boost::simd::Zero<vT>(),boost::simd::Zero<vT>())[0], boost::simd::Zero<sr_t>());
