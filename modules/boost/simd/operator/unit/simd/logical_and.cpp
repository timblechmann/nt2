...
NT2_TEST_CASE_TPL ( logical_and_integer__2_0, BOOST_SIMD_SIMD_INTEGRAL_TYPES)// (boost::simd::uint32_t)(boost::simd::int32_t)(boost::simd::int64_t))//
{
  ...
  NT2_TEST_EQUAL(logical_and(boost::simd::One<vT>(), boost::simd::One<vT>())&1!=0, boost::simd::True<sr_t>());
  NT2_TEST_EQUAL(logical_and(boost::simd::One<vT>(),boost::simd::Zero<vT>())&1!=0, boost::simd::False<sr_t>());
  NT2_TEST_EQUAL(logical_and(boost::simd::Zero<vT>(), boost::simd::Zero<vT>())&1!=0, boost::simd::False<sr_t>());
...
NT2_TEST_CASE_TPL ( logical_and_real__2_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_EQUAL(logical_and(boost::simd::Inf<vT>(), boost::simd::Inf<vT>())&1!=0, boost::simd::True<sr_t>());
  NT2_TEST_EQUAL(logical_and(boost::simd::Minf<vT>(), boost::simd::Minf<vT>())&1!=0, boost::simd::True<sr_t>());
  NT2_TEST_EQUAL(logical_and(boost::simd::Nan<vT>(), boost::simd::Nan<vT>())&1!=0, boost::simd::True<sr_t>());
  NT2_TEST_EQUAL(logical_and(boost::simd::One<vT>(),boost::simd::Zero<vT>())&1!=0, boost::simd::False<sr_t>());
  NT2_TEST_EQUAL(logical_and(boost::simd::Zero<vT>(), boost::simd::Zero<vT>())&1!=0, boost::simd::False<sr_t>());
