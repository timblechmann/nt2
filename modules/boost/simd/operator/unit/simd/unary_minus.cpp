...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 boost.simd.operator toolbox - unary_minus/simd Mode"
...
NT2_TEST_CASE_TPL ( unary_minus_real__1_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(unary_minus(boost::simd::Inf<vT>())[0], boost::simd::Minf<sr_t>());
  NT2_TEST_EQUAL(unary_minus(boost::simd::Minf<vT>())[0], boost::simd::Inf<sr_t>());
