...
namespace boost { namespace simd {  namespace memory
{
  ...
  **/
  ...
  {
    return static_cast<byte*> ( aligned_malloc( nbytes
  ...
  **/
  ...
  {
    return reinterpret_cast<byte*>(aligned_malloc(nbytes, align));
  }
  ...
  **/
  ...
  allocate(std::size_t nbytes, std::nothrow_t const & t)
  {
    return  static_cast<byte*>( aligned_malloc( nbytes, Alignment) );
  }
  ...
  **/
  ...
  {
    byte* result = allocate(nbytes, std::nothrow_t());
  ...
  **/
  ...
  allocate(std::size_t nbytes)
  {
    return  static_cast<byte*>( memory::aligned_malloc( nbytes, Alignment) );
  }
  ...
  **/
  ...
  {
    return allocate(alloc,nbytes,BOOST_SIMD_CONFIG_ALIGNMENT);
  }
} } }
