...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_MEMORY_FUNCTIONS_SIMD_SSE_AVX_UNALIGNED_LOAD_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_MEMORY_FUNCTIONS_SIMD_SSE_AVX_UNALIGNED_LOAD_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                            ...
                            )
  {
    ...
    inline result_type operator()(const A0& a0, const A1& a1, const A2&)const
    {
      return _mm256_loadu_si256(reinterpret_cast<__m256i const*>(a0+a1));
    }
  };
} } }
