...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_MEMORY_FUNCTIONS_SIMD_SSE_AVX_DETAILS_LOAD_OFFSET_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_MEMORY_FUNCTIONS_SIMD_SSE_AVX_DETAILS_LOAD_OFFSET_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( boost::simd::tag::load_ , boost::simd::tag::avx_
                            ...
                            , (iterator_< scalar_< arithmetic_<A0> > >)
                              ...
                              ((target_< simd_< arithmetic_<A2>, boost::simd::tag::avx_ > >))
