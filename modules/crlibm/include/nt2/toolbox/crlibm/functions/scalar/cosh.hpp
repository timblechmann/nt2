...
//==============================================================================
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_SCALAR_COSH_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_SCALAR_COSH_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::crlibm::tag::cosh_<Rounding>, tag::cpu_,
                      (A0)(Rounding),
                     ...
                     )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      ...
      return nt2::crlibm::cosh<Rounding>(type(a0));
    }
  };
...
/////////////////////////////////////////////////////////////////////////////
  ...
  {
    typedef typename boost::dispatch::meta::as_floating<A0>::type result_type;
    template<class A, class R> struct inner_cosh;
