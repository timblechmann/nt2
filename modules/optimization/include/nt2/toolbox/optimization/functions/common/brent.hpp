...
//==============================================================================
#ifndef NT2_TOOLBOX_OPTIMIZATION_FUNCTIONS_COMMON_BRENT_HPP_INCLUDED
#define NT2_TOOLBOX_OPTIMIZATION_FUNCTIONS_COMMON_BRENT_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION( brent_, tag::cpu_
                            , (F)(T)(O)
                            , (unspecified_< F >)
