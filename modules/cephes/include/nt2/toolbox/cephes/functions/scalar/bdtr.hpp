...
//==============================================================================
#ifndef NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_BDTR_HPP_INCLUDED
#define NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_BDTR_HPP_INCLUDED
#include <nt2/sdk/meta/adapted_traits.hpp>

  extern "C"{
    extern float cephes_bdtrf ( int,int,float );
    extern double cephes_bdtr ( int,int,double );
    extern long double cephes_bdtrl ( int,int,long double );
  }
...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::cephes::tag::bdtr_, tag::cpu_
                            , (A0)(A1)(A2)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(3)
    {
      return nt2::cephes::bdtr((a0), (a1), result_type(a2));
    }
  };
} }
