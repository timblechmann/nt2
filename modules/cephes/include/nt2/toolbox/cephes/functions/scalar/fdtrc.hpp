...
//==============================================================================
#ifndef NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_FDTRC_HPP_INCLUDED
#define NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_FDTRC_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::cephes::tag::fdtrc_, tag::cpu_
                            , (A0)(A1)(A2)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(3)
    {
      return nt2::cephes::fdtrc((a0), (a1), result_type(a2));
    }
  };
} }
