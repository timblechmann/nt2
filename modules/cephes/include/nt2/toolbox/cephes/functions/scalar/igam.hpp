...
//==============================================================================
#ifndef NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_IGAM_HPP_INCLUDED
#define NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_IGAM_HPP_INCLUDED

  extern "C"{
    extern float cephes_igamf ( float,float );
...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::cephes::tag::igam_, tag::cpu_
                            , (A0)(A1)
