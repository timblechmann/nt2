...
//==============================================================================
#ifndef NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_NBDTRC_HPP_INCLUDED
#define NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_NBDTRC_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::cephes::tag::nbdtrc_, tag::cpu_
                            , (A0)(A1)(A2)
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(3)
    { return cephes_nbdtrcf(a0, a1, a2); }
  };
} }
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(3)
    { return cephes_nbdtrcl(a0, a1, a2); }
  };
} }
