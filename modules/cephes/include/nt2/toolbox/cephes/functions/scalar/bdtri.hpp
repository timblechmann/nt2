...
//==============================================================================
#ifndef NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_BDTRI_HPP_INCLUDED
#define NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_BDTRI_HPP_INCLUDED
#include <nt2/sdk/meta/adapted_traits.hpp>

  extern "C"{
    extern float cephes_bdtrif ( int,int,float );
    extern double cephes_bdtri ( int,int,double );
    extern long double cephes_bdtril ( int,int,long double );
  }
...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::cephes::tag::bdtri_, tag::cpu_
                            , (A0)(A1)(A2)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(3)
    {
      return nt2::cephes::bdtri((a0), (a1), result_type(a2));
    }
  };
} }
