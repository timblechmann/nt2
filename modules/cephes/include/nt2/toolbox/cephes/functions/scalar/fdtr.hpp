...
//==============================================================================
#ifndef NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_FDTR_HPP_INCLUDED
#define NT2_TOOLBOX_CEPHES_FUNCTIONS_SCALAR_FDTR_HPP_INCLUDED
#include <nt2/sdk/meta/adapted_traits.hpp>

  extern "C"{
    extern float cephes_fdtrf ( int,int,float );
    extern double cephes_fdtr ( int,int,double );
    extern long double cephes_fdtrl ( int,int,long double );
  }
...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::cephes::tag::fdtr_, tag::cpu_
                            , (A0)(A1)(A2)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(3)
    {
      return nt2::cephes::fdtr((a0), (a1), result_type(a2));
    }
  };
} }
