...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::boost_math::tag::gamma_q_inva_, tag::cpu_
                            , (A0)(A1)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return nt2::boost_math::gamma_q_inva(result_type(a0), result_type(a1));
    }
  };
} }
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    { return boost::math::gamma_q_inva(a0, a1, nt2_policy()); }
  };
} }
