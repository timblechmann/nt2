 ...
 * \file
**/
#ifndef NT2_TOOLBOX_EXPONENTIAL_FUNCTIONS_POW_ABSI_HPP_INCLUDED
#define NT2_TOOLBOX_EXPONENTIAL_FUNCTIONS_POW_ABSI_HPP_INCLUDED
 ...
 * {
 *   template <class A0>
 *     meta::call<tag::pow_absi_(A0,A0)>::type
 *     pow_absi(const A0 & a0,const A0 & a1);
 * }
 * \endcode
 *
