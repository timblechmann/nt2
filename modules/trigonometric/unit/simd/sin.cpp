...
//   NT2_TEST_ULP_EQUAL(sin(-nt2::Pi<vT>())[0], nt2::Mone<sr_t>(), 0.5);
//   NT2_TEST_ULP_EQUAL(sin(-nt2::Pi<vT>()/nt2::splat<vT>(2))[0], nt2::Zero<sr_t>(), 0.5);
...
//   NT2_TEST_ULP_EQUAL(sin(nt2::Pi<vT>()/nt2::splat<vT>(2))[0], nt2::Zero<sr_t>(), 0.5);
//   NT2_TEST_ULP_EQUAL(sin(nt2::Pi<vT>()/nt2::splat<vT>(4))[0], nt2::Sqrt_2o_2<sr_t>(), 0.5);
//   NT2_TEST_ULP_EQUAL(sin(nt2::Zero<vT>())[0], nt2::One<sr_t>(), 0.5);
...
// NT2_TEST_CASE_TPL ( sin_real_convert__1_0,  NT2_REAL_CONVERTIBLE_TYPES)
// {
//   using nt2::sin;
//   using nt2::tag::sin_;
//   using nt2::load; 
...
//   // random verifications
// //   static const uint32_t NR = 100000;
// //   {
// //     NT2_CREATE_BUF(tab_a0,T, NR, T(-64), T(64));
// //     double ulp0, ulpd ; ulpd=ulp0=0.0;
// //     for(uint32_t j = 0; j < NR/cardinal_of<n_t>::value; j++)
// //       {
// //         vT a0 = load<vT>(&tab_a0[0],j);
