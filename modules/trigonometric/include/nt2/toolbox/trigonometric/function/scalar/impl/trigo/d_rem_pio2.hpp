 ...
 ******************************************************************************/
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTION_SCALAR_IMPL_TRIGO_D_REM_PIO2_HPP_INCLUDED
#define NT2_TOOLBOX_TRIGONOMETRIC_FUNCTION_SCALAR_IMPL_TRIGO_D_REM_PIO2_HPP_INCLUDED
...
namespace nt2 {
  ...
  namespace details
  {
	...
	{
	  A0 y[2];
	  int32_t n1 = __ieee754_rem_pio2(x, y);
	  n =  n1; 
	  xr = y[0];
	  xc = y[1];
	}
