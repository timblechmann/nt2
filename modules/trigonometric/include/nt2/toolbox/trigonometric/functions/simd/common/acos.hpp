...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return ifnanelse(gt(abs(a0), One<A0>()), oneminus(nt2::sign(tofloat(a0)))*Pio_2<result_type>()); 
	//      return b_or(oneminus(nt2::sign(tofloat(a0)))*Pio_2<result_type>(), gt(abs(a0), One<A0>()));
    }
  };
} }
