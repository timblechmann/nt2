...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN( nt2::tag::cotangent_<mode>, boost::simd::tag::simd_
                     , (A0)(mode)(X)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      A0 that = {impl::trig_base<result_type,radian_tag,tag::simd_type,mode>::cota(tofloat(a0))}; 
      return that;
    }
  };
} }
