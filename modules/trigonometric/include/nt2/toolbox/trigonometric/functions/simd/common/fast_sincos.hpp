...
//==============================================================================
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SIMD_COMMON_FAST_SINCOS_HPP_INCLUDED
#define NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SIMD_COMMON_FAST_SINCOS_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION_IF(fast_sincos_, boost::simd::tag::simd_,(A0)(A1)(X),
  ...
  /////////////////////////////////////////////////////////////////////////////
  NT2_FUNCTOR_IMPLEMENTATION(fast_sincos_, boost::simd::tag::simd_,
                              (A0)(X),
                              ((simd_<arithmetic_<A0>,X>))
                             )
  {
