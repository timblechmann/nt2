...
{
  NT2_FUNCTOR_IMPLEMENTATION_IF_GEN(nt2::tag::sinecosine_<mode>, boost::simd::tag::simd_,(A0)(A1)(mode)(X), 
  ...
  /////////////////////////////////////////////////////////////////////////////
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::tag::sinecosine_<mode>, boost::simd::tag::simd_,
                         (A0)(mode)(X),
                         ((simd_<arithmetic_<A0>,X>))
                        )
  {
