...
//==============================================================================
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SIMD_COMMON_FAST_COTPI_HPP_INCLUDED
#define NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SIMD_COMMON_FAST_COTPI_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION( fast_cotpi_, boost::simd::tag::simd_
                            , (A0)(X)
                            , ((simd_<signed_<A0>,X>))
                            )
  {
