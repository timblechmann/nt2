...
//==============================================================================
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SCALAR_SINCOS_HPP_INCLUDED
#define NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SCALAR_SINCOS_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION(sincos_, tag::cpu_,
			     (A0)(A1),
			     ...
			     )
  {
    ...
    {
      a1 = impl::trig_base <A1,radian_tag,tag::not_simd_type>::sincosa(A1(a0),a2);
      return 0; 
    }
  };
