...
//==============================================================================
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SCALAR_COSD_HPP_INCLUDED
#define NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SCALAR_COSD_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION( cosd_, tag::cpu_
                            , (A0)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return nt2::cosd(result_type(a0));
    }
  };
} }
