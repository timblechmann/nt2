...
//==============================================================================
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SCALAR_FAST_COTD_HPP_INCLUDED
#define NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SCALAR_FAST_COTD_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      ...
      return nt2::fast_cotd(result_type(a0));
    }
  };
} }
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      ...
      return impl::trig_base<A0,degree_tag,  tag::not_simd_type, clipped_pio4>::cota(a0);
    }
  };
} }
