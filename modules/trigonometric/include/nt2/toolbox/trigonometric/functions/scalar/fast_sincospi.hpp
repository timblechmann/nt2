...
//==============================================================================
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SCALAR_FAST_SINCOSPI_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION(fast_sincospi_, tag::cpu_,
			     (A0)(A1),
			     ...
			     )
  {
    ...
    {
      a1 = impl::trig_base <A1,pi_tag,fast_tag,tag::not_simd_type>::sincosa(A1(a0),a2);
      return 0; 
    }
  };
			     ...
			     )
  {
    ...
    {
      return impl::trig_base <A1,pi_tag,fast_tag,tag::not_simd_type>::sincosa(A1(a0),a2);
    }
  };
