...
NT2_TEST_CASE_TPL ( abs_cplx__1_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  {
    typedef vcT r_t;
    NT2_TEST_ULP_EQUAL(nt2::sqr(nt2::splat<vcT>(cT(1, 1)))[0], cT(0, 2),0);
  }
  {
    typedef vdT r_t;
  ...
  {
    typedef vT r_t;
    NT2_TEST_ULP_EQUAL(nt2::sqr(nt2::splat<vdT>(dT(-1)))[0], nt2::One<dT>(),0);
    NT2_TEST_ULP_EQUAL(nt2::sqr(nt2::Inf<vdT>())[0], nt2::Inf<dT>(),0);
    NT2_TEST_ULP_EQUAL(nt2::sqr(nt2::Minf<vdT>())[0], nt2::Inf<dT>(),0);
    NT2_TEST_ULP_EQUAL(nt2::sqr(nt2::Mone<vdT>())[0], nt2::One<dT>(),0);
    NT2_TEST_ULP_EQUAL(nt2::sqr(nt2::Nan<vdT>())[0], nt2::Nan<dT>(),0);
    NT2_TEST_ULP_EQUAL(nt2::sqr(nt2::One<vdT>())[0], nt2::One<dT>(),0);
    NT2_TEST_ULP_EQUAL(nt2::sqr(nt2::Zero<vdT>())[0], nt2::Zero<dT>(),0);
  }
