...
NT2_TEST_CASE_TPL ( abs_cplx__1_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  // specific values tests
  {
    ...
    NT2_TEST_ULP_EQUAL(nt2::imag(nt2::Mone<vcT>())[0], nt2::Zero<T>(),0);
  ...
  }
  {
    ...
    NT2_TEST_ULP_EQUAL(nt2::imag(nt2::Nan<vciT>())[0], nt2::Nan<T>(),0);
    NT2_TEST_ULP_EQUAL(nt2::imag(nt2::One<vciT>())[0], nt2::One<T>(),0);
  ...
  }
  {
    ...
    NT2_TEST_ULP_EQUAL(nt2::imag(nt2::Nan<vdT>())[0], nt2::Zero<T>(),0);
    NT2_TEST_ULP_EQUAL(nt2::imag(nt2::One<vdT>())[0], nt2::Zero<T>(),0);
    NT2_TEST_ULP_EQUAL(nt2::imag(nt2::Zero<vdT>())[0], nt2::Zero<T>(),0);
  }
