...
NT2_TEST_CASE_TPL ( definitely_not_equal_real__3_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(definitely_not_equal(nt2::splat<vT>(0),nt2::splat<vT>(0),nt2::splat<ivT>(1))REF!=0, nt2::False<sr_t>());
  NT2_TEST_EQUAL(definitely_not_equal(nt2::splat<vT>(0),nt2::splat<vT>(1),nt2::splat<ivT>(1))REF!=0, nt2::True<sr_t>());
...
NT2_TEST_CASE_TPL ( definitely_not_equal_signed_int__3_0,  NT2_SIMD_INTEGRAL_SIGNED_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_EQUAL(definitely_not_equal(nt2::splat<vT>(0),nt2::splat<vT>(0),nt2::splat<ivT>(1))REF!=0, nt2::False<sr_t>());
  NT2_TEST_EQUAL(definitely_not_equal(nt2::splat<vT>(0),nt2::splat<vT>(1),nt2::splat<ivT>(1))REF!=0, nt2::False<sr_t>());
