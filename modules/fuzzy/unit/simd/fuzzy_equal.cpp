...
NT2_TEST_CASE_TPL ( fuzzy_equal_real__3_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(fuzzy_equal(nt2::splat<vT>(0),nt2::splat<vT>(0),nt2::splat<vT>(1))REF!=0, nt2::True<sr_t>());
  NT2_TEST_EQUAL(fuzzy_equal(nt2::splat<vT>(0),nt2::splat<vT>(1),nt2::splat<vT>(1))REF!=0, nt2::True<sr_t>());
  NT2_TEST_EQUAL(fuzzy_equal(nt2::splat<vT>(0),nt2::splat<vT>(2),nt2::splat<vT>(0.25))REF!=0, nt2::False<sr_t>());
