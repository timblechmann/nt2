 ...
 * \file
**/
#ifndef NT2_TOOLBOX_FUZZY_FUNCTIONS_TOLERANT_FLOOR_HPP_INCLUDED
#define NT2_TOOLBOX_FUZZY_FUNCTIONS_TOLERANT_FLOOR_HPP_INCLUDED
#include <nt2/include/simd.hpp>
#include <nt2/include/functor.hpp>

/*!
 * \ingroup fuzzy
 * \defgroup fuzzy_tolerant_floor tolerant_floor
 *
 * \par Description
 ...
 * {
 *   template <class A0>
 *     meta::call<tag::tolerant_floor_(A0)>::type
 *     tolerant_floor(const A0 & a0);
 * }
 * \endcode
 *
 * \param a0 the first parameter of tolerant_floor
 * 
