 ...
 * \file
**/
#ifndef NT2_TOOLBOX_FUZZY_FUNCTIONS_TOLERANT_TRUNC_HPP_INCLUDED
#define NT2_TOOLBOX_FUZZY_FUNCTIONS_TOLERANT_TRUNC_HPP_INCLUDED
#include <nt2/include/simd.hpp>
#include <nt2/include/functor.hpp>

/*!
 * \ingroup fuzzy
 * \defgroup fuzzy_tolerant_trunc tolerant_trunc
 *
 * \par Description
 ...
 * 
 * \code
 * #include <nt2/include/functions/tolerant_trunc.hpp>
 * \endcode
 * 
 * 
 * \synopsis
 ...
 * {
 *   template <class A0>
 *     meta::call<tag::tolerant_trunc_(A0)>::type
 *     tolerant_trunc(const A0 & a0);
 * }
 * \endcode
 *
 * \param a0 the first parameter of tolerant_trunc
 * 
