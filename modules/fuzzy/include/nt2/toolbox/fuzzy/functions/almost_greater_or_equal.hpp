 ...
 * \file
**/
#ifndef NT2_TOOLBOX_FUZZY_FUNCTIONS_ALMOST_GREATER_OR_EQUAL_HPP_INCLUDED
...
/*!
 * \ingroup fuzzy
 * \defgroup fuzzy_almost_greater_or_equal almost_greater_or_equal
 *
 * \par Description
 ...
 * {
 *   template <class A0>
 *     meta::call<tag::almost_greater_or_equal_(A0,A0,A0)>::type
 *     almost_greater_or_equal(const A0 & a0,const A0 & a1,const A0 & a2);
 * }
 * \endcode
 *
...
namespace nt2 { namespace tag
  {
    ...
    **/
    ...
    NT2_FUNCTION_DECLARE(almost_greater_or_equal_)
  }
