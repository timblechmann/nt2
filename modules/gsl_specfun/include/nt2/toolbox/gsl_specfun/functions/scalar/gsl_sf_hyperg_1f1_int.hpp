...
//==============================================================================
#ifndef NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_SCALAR_GSL_SF_HYPERG_1F1_INT_HPP_INCLUDED
#define NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_SCALAR_GSL_SF_HYPERG_1F1_INT_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::gsl_specfun::tag::gsl_sf_hyperg_1f1_int_, tag::cpu_
                            , (A0)(A1)(A2)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(3)
    {
      return nt2::gsl_specfun::gsl_sf_hyperg_1f1_int((a0), (a1), result_type(a2));
    }
  };
} }
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(3)
    { return gsl_sf_hyperg_1F1_int(a0, a1, a2); }
  };
} }
