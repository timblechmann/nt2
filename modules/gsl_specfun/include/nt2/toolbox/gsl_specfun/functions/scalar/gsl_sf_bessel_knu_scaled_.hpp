...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::gsl_specfun::tag::gsl_sf_bessel_knu_scaled__, tag::cpu_
                            , (A0)(A1)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return nt2::gsl_specfun::gsl_sf_bessel_knu_scaled_(result_type(a0), result_type(a1));
    }
  };
} }
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    { return gsl_sf_bessel_Knu_scaled(a0, a1); }
  };
} }
