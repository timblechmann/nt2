...
//==============================================================================
#ifndef NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_SCALAR_GSL_SF_BESSEL_KN_HPP_INCLUDED
#define NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_SCALAR_GSL_SF_BESSEL_KN_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION_GEN(nt2::gsl_specfun::tag::gsl_sf_bessel_kn_, tag::cpu_
                            , (A0)(A1)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return nt2::gsl_specfun::gsl_sf_bessel_kn(a0, result_type(a1));
    }
  };
} }
