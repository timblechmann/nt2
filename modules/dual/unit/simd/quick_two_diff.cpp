...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 dual toolbox - quick_two_diff/simd Mode"
...
NT2_TEST_CASE_TPL ( quick_two_diff_real__2_0,  NT2_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<quick_two_diff_(vT,vT)>::type r_t;
  typedef typename nt2::meta::call<quick_two_diff_(T,T)>::type sr_t;
