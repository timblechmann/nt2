...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 dual toolbox - two_sqr/simd Mode"
...
NT2_TEST_CASE_TPL ( two_sqr_real__1_0,  NT2_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<two_sqr_(vT)>::type r_t;
  typedef typename nt2::meta::call<two_sqr_(T)>::type sr_t;
