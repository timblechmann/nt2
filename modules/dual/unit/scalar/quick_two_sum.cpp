...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 dual toolbox - quick_two_sum/scalar Mode"
...
NT2_TEST_CASE_TPL ( quick_two_sum_real__2_0,  NT2_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<quick_two_sum_(T,T)>::type r_t;
  ...
  ulpd=0.0;
  r_t res;
  res = quick_two_sum(nt2::One<T>(), nt2::Eps<T>()/nt2::Two<T>());
