...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 dual toolbox - two_diff/scalar Mode"
...
NT2_TEST_CASE_TPL ( two_diff_real__2_0,  NT2_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<two_diff_(T,T)>::type r_t;
  ...
  ulpd=0.0;
  r_t res;
  res = two_diff(nt2::One<T>(), nt2::Eps<T>()/nt2::Four<T>());
