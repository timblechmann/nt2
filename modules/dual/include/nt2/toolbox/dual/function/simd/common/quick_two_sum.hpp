...
//////////////////////////////////////////////////////////////////////////////
#ifndef NT2_TOOLBOX_DUAL_FUNCTION_SIMD_COMMON_QUICK_TWO_SUM_HPP_INCLUDED
#define NT2_TOOLBOX_DUAL_FUNCTION_SIMD_COMMON_QUICK_TWO_SUM_HPP_INCLUDED
...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(tag::quick_two_sum_, tag::cpu_,
                       (A0)(X),
...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::quick_two_sum_(tag::simd_<tag::real_, X>,tag::simd_<tag::real_, X>),
  ...
  private:
    ...
    {
      s = a + b;
      err = sel(is_inf(s), Zero<R1>(), b - (s - a));
    }
  };
} }
