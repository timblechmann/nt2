...
{
  NT2_FUNCTOR_IMPLEMENTATION( cospi_, tag::cpu_, (A0)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return bitwise_cast<result_type>(nt2::cosh(imag(a0)*Pi<rtype>())); 
    }
  };
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return bitwise_cast<result_type>(nt2::cospi(real(a0))); 
    }
  };
} }
