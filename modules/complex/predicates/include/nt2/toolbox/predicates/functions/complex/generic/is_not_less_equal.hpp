...
{
  // complex/complex
  NT2_FUNCTOR_IMPLEMENTATION( is_not_less_equal_, tag::cpu_, (A0)
  ...
  // complex/arithmetic
  NT2_FUNCTOR_IMPLEMENTATION( is_not_less_equal_, tag::cpu_, (A0)(A1)
                            , (generic_< complex_< arithmetic_<A0> > >)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return is_not_less_equal(real(a1),real(a0)); 
    }
  };
  // complex/imaginary
  NT2_FUNCTOR_IMPLEMENTATION( is_not_less_equal_, tag::cpu_, (A0)(A1)
