 ...
 * \file
**/
#ifndef NT2_TOOLBOX_COMPLEX_FUNCTIONS_MUL_MINUS_I_HPP_INCLUDED
#define NT2_TOOLBOX_COMPLEX_FUNCTIONS_MUL_MINUS_I_HPP_INCLUDED
...
namespace nt2
{
  namespace tag
  {
    ...
    **/
    ...
    NT2_FUNCTION_DECLARE(mul_minus_i_)
  }
