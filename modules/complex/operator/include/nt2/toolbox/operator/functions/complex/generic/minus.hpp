...
{
  // complex/complex
  NT2_FUNCTOR_IMPLEMENTATION( minus_, tag::cpu_, (A0)
  ...
  // complex/real
  NT2_FUNCTOR_IMPLEMENTATION( minus_, tag::cpu_, (A0)(A1)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return result_type(real(a0)-real(a1), -imag(a1));
    }
  };
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return result_type(real(a0)-real(a1), imag(a0));
    }
  };
