...
//==============================================================================
#ifndef NT2_TOOLBOX_LINALG_FUNCTIONS_EXPR_LU_HPP_INCLUDED
#define NT2_TOOLBOX_LINALG_FUNCTIONS_EXPR_LU_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0& a0, A1& a1) const
    {
      ...
      a0 = factorization::lu(a0,'U',in_place_).upper_result();
      return a0;
    }
  };
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0& a0, A1& a1) const
    {
      ...
      a0 = factorization::lu(a0,'L',in_place_).lower_result();
      return a0;
    }
  };
