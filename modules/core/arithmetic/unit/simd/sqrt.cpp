...
NT2_TEST_CASE_TPL ( sqrt_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::sqrt;
  using nt2::tag::sqrt_;
  ...
  NT2_TEST_ULP_EQUAL(sqrt(nt2::Four<vT>())[0], nt2::Two<sr_t>(), 0);
  ...
  NT2_TEST_ULP_EQUAL(sqrt(nt2::Two<vT>())[0], nt2::Sqrt_2<sr_t>(), 0.5);
