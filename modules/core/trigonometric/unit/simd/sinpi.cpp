...
NT2_TEST_CASE_TPL ( sinpi_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(sinpi(nt2::Half<vT>())[0], nt2::One<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(sinpi(nt2::Inf<vT>())[0], nt2::Nan<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(sinpi(nt2::Mhalf<vT>())[0], -nt2::One<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(sinpi(nt2::Minf<vT>())[0], nt2::Nan<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(sinpi(nt2::Nan<vT>())[0], nt2::Nan<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(sinpi(nt2::One<vT>())[0], nt2::Zero<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(sinpi(nt2::Quarter<vT>())[0], nt2::Sqrt_2o_2<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(sinpi(nt2::Zero<vT>())[0], nt2::Zero<sr_t>(), 0.5);
