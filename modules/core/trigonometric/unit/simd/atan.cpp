...
NT2_TEST_CASE_TPL ( atan_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(atan(nt2::Half<vT>())[0], 4.636476090008061e-01, 0.5);
  NT2_TEST_ULP_EQUAL(atan(nt2::Inf<vT>())[0], nt2::Pi<sr_t>()/2, 0.5);
  NT2_TEST_ULP_EQUAL(atan(nt2::Mhalf<vT>())[0], -4.636476090008061e-01, 0.5);
  NT2_TEST_ULP_EQUAL(atan(nt2::Minf<vT>())[0], -nt2::Pi<sr_t>()/2, 0.5);
  NT2_TEST_ULP_EQUAL(atan(nt2::Mone<vT>())[0], -nt2::Pi<sr_t>()/4, 0.5);
