...
NT2_TEST_CASE_TPL ( cosecant_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium_>(-nt2::Pi<vT>()/nt2::splat<vT>(2))[0], nt2::Mone<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium_>(-nt2::Pi<vT>()/nt2::splat<vT>(4))[0], -nt2::Sqrt_2<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium_>(nt2::Mzero<vT>())[0], nt2::Minf<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium_>(nt2::Inf<vT>())[0], nt2::Nan<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium_>(nt2::Minf<vT>())[0], nt2::Nan<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium_>(nt2::Nan<vT>())[0], nt2::Nan<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium_>(nt2::Pi<vT>()/nt2::splat<vT>(2))[0], nt2::One<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium_>(nt2::Pi<vT>()/nt2::splat<vT>(4))[0], nt2::Sqrt_2<sr_t>(), 0.5);
