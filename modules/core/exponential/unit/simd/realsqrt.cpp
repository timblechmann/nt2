...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 exponential toolbox - realsqrt/simd Mode"
...
NT2_TEST_CASE_TPL ( realsqrt_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::realsqrt;
  ...
  typedef typename nt2::meta::call<realsqrt_(T)>::type sr_t;
  ...
  NT2_TEST_ULP_EQUAL(realsqrt(nt2::Inf<vT>())[0], nt2::Inf<sr_t>(), 0);
