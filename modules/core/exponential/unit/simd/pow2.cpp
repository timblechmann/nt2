...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 exponential toolbox - pow2/simd Mode"
...
NT2_TEST_CASE_TPL ( pow2_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<pow2_(T)>::type sr_t;
  ...
  for(unsigned int i = 0; i < cardinal_of<vT>::value; ++i)
    {
      ...
      NT2_TEST_EQUAL( nt2::pow2( boost::simd::One<vT>()
                      ...
                      , nt2::pow2( boost::simd::One<T>()
                                   , boost::simd::Two<iT>()
                                   )
                      );
    }
  // specific values tests
   NT2_TEST_ULP_EQUAL(pow2(nt2::Inf<vT>())[0], nt2::Inf<sr_t>(), 0);
   NT2_TEST_ULP_EQUAL(pow2(nt2::Minf<vT>())[0], nt2::Zero<sr_t>(), 0);
