...
NT2_TEST_CASE_TPL ( expx2_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(expx2(nt2::Minf<vT>())[0], nt2::Inf<sr_t>(), 1.0);
  NT2_TEST_ULP_EQUAL(expx2(nt2::Mone<vT>())[0], nt2::Exp_1<sr_t>(), 1.0);
  NT2_TEST_ULP_EQUAL(expx2(nt2::Nan<vT>())[0], nt2::Nan<sr_t>(), 1.0);
  NT2_TEST_ULP_EQUAL(expx2(nt2::One<vT>())[0], nt2::Exp_1<sr_t>(), 1.0);
  NT2_TEST_ULP_EQUAL(expx2(nt2::Zero<vT>())[0], nt2::One<sr_t>(), 1.0);
