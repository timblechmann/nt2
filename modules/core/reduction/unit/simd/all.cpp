...
NT2_TEST_CASE_TPL ( all_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(nt2::all(nt2::Mone<vT>()), nt2::True<sr_t>());
  NT2_TEST_EQUAL(nt2::all(nt2::Nan<vT>()), nt2::True<sr_t>());
  NT2_TEST_EQUAL(nt2::all(nt2::One<vT>()), nt2::True<sr_t>());
  NT2_TEST_EQUAL(nt2::all(nt2::Zero<vT>()), nt2::False<sr_t>());
