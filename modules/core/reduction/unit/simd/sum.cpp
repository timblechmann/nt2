...
NT2_TEST_CASE_TPL ( sum_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(sum(nt2::Inf<vT>()), nt2::Inf<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(sum(nt2::Minf<vT>()), nt2::Minf<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(sum(nt2::Mone<vT>()), -int(cardinal_of<n_t>()), 0);
  NT2_TEST_ULP_EQUAL(sum(nt2::Nan<vT>()), nt2::Nan<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(sum(nt2::One<vT>()), int(cardinal_of<n_t>()), 0);
  NT2_TEST_ULP_EQUAL(sum(nt2::Zero<vT>()), nt2::Zero<sr_t>(), 0);
