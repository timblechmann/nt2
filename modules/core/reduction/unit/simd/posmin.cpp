...
NT2_TEST_CASE_TPL ( posmin_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(posmin(nt2::Inf<vT>()), nt2::Zero<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(posmin(nt2::Minf<vT>()), nt2::Zero<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(posmin(nt2::Mone<vT>()), nt2::Zero<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(posmin(nt2::Nan<vT>()), nt2::Zero<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(posmin(nt2::One<vT>()), nt2::Zero<sr_t>(), 0);
  NT2_TEST_ULP_EQUAL(posmin(nt2::Zero<vT>()), nt2::Zero<sr_t>(), 0);
