...
NT2_TEST_CASE_TPL ( inbtrue_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(inbtrue(nt2::Inf<vT>()), cardinal_of<vT>::value, 0);
  NT2_TEST_ULP_EQUAL(inbtrue(nt2::Minf<vT>()), cardinal_of<vT>::value, 0);
  NT2_TEST_ULP_EQUAL(inbtrue(nt2::Mone<vT>()), cardinal_of<vT>::value, 0);
  NT2_TEST_ULP_EQUAL(inbtrue(nt2::Nan<vT>()), cardinal_of<vT>::value, 0);
  NT2_TEST_ULP_EQUAL(inbtrue(nt2::One<vT>()), cardinal_of<vT>::value, 0);
  NT2_TEST_ULP_EQUAL(inbtrue(nt2::Zero<vT>()), nt2::Zero<sr_t>(), 0);
