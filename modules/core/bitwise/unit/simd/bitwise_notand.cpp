...
NT2_TEST_CASE_TPL ( bitwise_notand_real__2_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(bitwise_notand(nt2::Inf<vT>(), nt2::Inf<vT>())[0], nt2::Zero<sr_t>());
  NT2_TEST_EQUAL(bitwise_notand(nt2::Minf<vT>(), nt2::Minf<vT>())[0], nt2::Zero<sr_t>());
  NT2_TEST_EQUAL(bitwise_notand(nt2::Nan<vT>(), nt2::Nan<vT>())[0], nt2::Zero<sr_t>());
...
NT2_TEST_CASE_TPL ( bitwise_notand_integer__2_0,  NT2_SIMD_INTEGRAL_TYPES)
{
  using nt2::bitwise_notand;
  using nt2::tag::bitwise_notand_;
  using boost::simd::native;
