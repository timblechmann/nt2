...
NT2_TEST_CASE_TPL ( laguerre_real__2_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(laguerre(1,nt2::Half<vT>())[0], nt2::Half<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(laguerre(1,nt2::Inf<vT>())[0], nt2::Minf<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(laguerre(1,nt2::Minf<vT>())[0], nt2::Inf<sr_t>(), 0.5);
