...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_PARTIAL_FOLD_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_PARTIAL_FOLD_HPP_INCLUDED

/*!
 * \file
 * \brief Defines and implements the nt2::partial_fold function
 */
...
namespace nt2
{
   ...
   */
  //============================================================================
  BOOST_DISPATCH_FUNCTION_IMPLEMENTATION_TPL(tag::partial_fold_, partial_fold, (A0 const&)(A1 const&)(A2 const&)(A3 const&)(A4 const&), 5)
  BOOST_DISPATCH_FUNCTION_IMPLEMENTATION_TPL(tag::partial_fold_, partial_fold, (A0&)(A1 const&)(A2 const&)(A3 const&)(A4 const&), 5)
