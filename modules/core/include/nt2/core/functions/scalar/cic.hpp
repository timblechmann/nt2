...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_SCALAR_CIC_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_SCALAR_CIC_HPP_INCLUDED

#include <nt2/core/container/dsl.hpp>
#include <nt2/core/functions/cic.hpp>
...
{
  //============================================================================
  // Generates cic from a pair of integers
  //============================================================================
                            ...
                            )
  {
    typedef typename  boost::proto::
      result_of::make_expr< nt2::tag::cic_
      , container::domain
      , box<_2D>
      , box< nt2::details::cic >
      ,  meta::as_<double>
    ...
    {
      return boost::proto::make_expr< nt2::tag::cic_
                                    , container::domain
                                    > ( boxify(of_size(n,m))
                                      , boxify(nt2::details::cic())
                                        , meta::as_<double>()
                                        );
    }
  };
  //============================================================================
  // Generates cic from one integer return doubles
  //============================================================================
  NT2_FUNCTOR_IMPLEMENTATION( cic_, tag::cpu_
                              , (A0)
                              , (scalar_< integer_<A0> >)
  ...
  //============================================================================
  // Generates cic from one integer
  //============================================================================
  NT2_FUNCTOR_IMPLEMENTATION( cic_, tag::cpu_
                              , (A0)(T)
                              , (scalar_< integer_<A0> >)
  ...
  //============================================================================
  // Generates cic from fusion sequence (support of_size calls)
  //============================================================================
  NT2_FUNCTOR_IMPLEMENTATION( cic_, tag::cpu_
                            , (Seq)
  ...
  //============================================================================
  // Generates cic from fusion sequence + types (support of_size calls)
  //============================================================================
  NT2_FUNCTOR_IMPLEMENTATION( cic_, tag::cpu_
                            , (Seq)(T)
                            , (fusion_sequence_<Seq>)
