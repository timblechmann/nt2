...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_SCALAR_RIF_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_SCALAR_RIF_HPP_INCLUDED
...
{
  //============================================================================
  // Generates rif from a pair of integers
  //============================================================================
  NT2_FUNCTOR_IMPLEMENTATION( rif_, tag::cpu_
                            , (A0)
                            , (scalar_< integer_<A0> >)
                              (scalar_< integer_<A0> >)
                            )
  ...
  //============================================================================
  // Generates rif from one integer return doubles
  //============================================================================
  NT2_FUNCTOR_IMPLEMENTATION( rif_, tag::cpu_
                              , (A0)
                              , (scalar_< integer_<A0> >)
  ...
  //============================================================================
  // Generates rif from one integer
  //============================================================================
  NT2_FUNCTOR_IMPLEMENTATION( rif_, tag::cpu_
                              , (A0)(T)
                              , (scalar_< integer_<A0> >)
  ...
  //============================================================================
  // Generates rif from fusion sequence (support of_size calls)
  //============================================================================
  NT2_FUNCTOR_IMPLEMENTATION( rif_, tag::cpu_
                            , (Seq)
  ...
  //============================================================================
  // Generates rif from fusion sequence + types (support of_size calls)
  //============================================================================
  NT2_FUNCTOR_IMPLEMENTATION( rif_, tag::cpu_
                            , (Seq)(T)
                            , (fusion_sequence_<Seq>)
