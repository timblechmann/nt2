...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_COMMON_ISVECTOR_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_COMMON_ISVECTOR_HPP_INCLUDED
...
{
  NT2_FUNCTOR_IMPLEMENTATION( isvector_, tag::cpu_
                            , (A0)
                            , (unspecified_<A0>)
                            )
  {
