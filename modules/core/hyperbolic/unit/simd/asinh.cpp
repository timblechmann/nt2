...
NT2_TEST_CASE_TPL ( asinh_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(asinh(nt2::Inf<vT>())[0], nt2::Inf<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(asinh(nt2::Minf<vT>())[0], nt2::Minf<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(asinh(nt2::Nan<vT>())[0], nt2::Nan<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(asinh(nt2::Zero<vT>())[0], nt2::Zero<sr_t>(), 0.5);
