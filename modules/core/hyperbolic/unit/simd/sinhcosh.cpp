...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 hyperbolic toolbox - sinhcosh/simd Mode"
...
NT2_TEST_CASE_TPL ( sinhcosh_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::sinhcosh;
  ...
  typedef typename nt2::meta::call<sinhcosh_(vT)>::type r_t;
  typedef typename nt2::meta::call<sinhcosh_(T)>::type sr_t;
