...
namespace nt2 { namespace ext
{
  ...
  bA0 nan =  b_or(is_ltz(a0), gt(a0, One<A0>()));
  A0 m = ifnotelsezero(nan, a0); 
  A0 aa0 = One<A0>();
  ...
  a2 = ifnanelse(nan, sel(iseqm1,Inf<A0>(), nt2::Pio_2<A0>()/aa1));
  a3 = ifnanelse(nan, sel(iseqm1,One<A0>(), a2*(One<A0>()-s0*Half<A0>()))); 
      }
  };
